...
@interface BridtvSdkViewManager : RCTViewManager
@end

@implementation BridtvSdkViewManager

RCT_EXPORT_MODULE(BridtvSdkView)
...
RCT_EXPORT_VIEW_PROPERTY(playerID, NSInteger);
RCT_EXPORT_VIEW_PROPERTY(mediaID, NSInteger);
RCT_EXPORT_VIEW_PROPERTY(tagType, NSInteger);
RCT_EXPORT_VIEW_PROPERTY(page, NSInteger);
RCT_EXPORT_VIEW_PROPERTY(item, NSInteger);
